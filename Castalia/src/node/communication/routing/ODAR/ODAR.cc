        ...
        case MONITOR_DAR:
        {
		    ...
		    while (flag)
		    {
                ...
                if (node_)
                {
                    ...
                    odarInstance->cdfCounter = 0;
                    odarInstance->pdrCounter = 0;
...
void ODAR::broadcastControl()
{
    ...
    if(resilientVersion){
        ...
        // set all pdr broadcast times to 10min in the future
...
void ODAR::checkCdfBroadcast()
{
    ...
    if(avg_difference == 0) {
        ...
        result = std::min((double) 30, 0.4/avg_difference);
    }
